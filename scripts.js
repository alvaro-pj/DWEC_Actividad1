    ...
    */
    const cargarTabla = (misProductos) => {
        ...
        misProductos.forEach(product => {
            ...
            btnDesc.classList.add("btn", "btn-sm", "btn-outline-secondary", "mt-1");
            btnDesc.setAttribute("data-bs-toggle", "collapse");
            btnDesc.setAttribute("data-bs-target", "#desc_" + product.SKU);
            btnDesc.textContent = "Ver descripción";

            const descDiv = document.createElement('div');
            descDiv.classList.add("collapse", "mt-2");
            descDiv.id = "desc_" + product.SKU;
            descDiv.innerHTML = `<small class="text-muted">${product.description}</small>`;

            divTitulo.append(titulo);
            divTitulo.append(ref);
            divTitulo.append(btnDesc);
            divTitulo.append(descDiv);
            ...
            //añadimos una clase de Boostrap a nuestro boton de +
            masButton.classList.add("btn", "btn-outline-dark");
            ...
            menosButton.classList.add("btn", "btn-outline-dark");
    ...
    fetch("https://mocki.io/v1/a6ec5dad-99e3-4c86-a81b-8a1b07e1525d")
